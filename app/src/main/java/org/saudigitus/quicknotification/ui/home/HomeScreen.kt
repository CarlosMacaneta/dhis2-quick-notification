...
fun HomeScreen(
    ...
    val pagedMessages = viewModel.getPagedMessageByMessageType(messageType)
    ...
    if (showChat) {
        Dialog(
            ...
            ConversationScreen(viewModel, messageType) { }
        }
    }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            messagesData.messageConversations?.let { messages ->
                items(
                    messages
                ) { conversation ->
                    TEIItem(
